...
describe('pet validation guards', () => {
  ...
  it('reports TypeScript and Rust desktop overlay bridge drift by registered command', () => {
    expect(collectDesktopPetOverlayContractDriftIssues({
      ...
      'TypeScript bridge missing startNativeDesktopPetOverlayWindowDrag',
      'TypeScript bridge missing command desktop_pet_overlay_start_native_window_drag',
      'Rust overlay missing command fn desktop_pet_overlay_start_native_window_drag',
      'Rust invoke handler missing desktop_pet_overlay_start_native_window_drag',
      'Rust caller validation missing desktop_pet_overlay_start_native_window_drag',
