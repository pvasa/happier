---
title: Daemon
description: Run Happier in the background for remote start, headless servers, and the embedded terminal.
---
...
In practice, it’s what enables Happier to **start and manage sessions even when you don’t have a terminal open**. That matters for features like **remote start** (for example from the app or web UI): the daemon is the thing on your computer that can receive the request and launch the session locally.
