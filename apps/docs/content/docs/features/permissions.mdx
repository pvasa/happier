...
For the full user-facing guide, see [Session modes](/docs/features/session-modes).
...
For the full guide to engine picking, dynamic/static model lists, custom model ids, model-specific options, and favorite models, see [Model and engine selection](/docs/features/model-and-engine-selection).
...
For the broader model, see [Happier tools & actions](/docs/features/happier-tools) and [Inbox and approvals](/docs/features/inbox-and-approvals).
