...
The installer runs `hstack setup` via `npx` (npm). (`hstack setup` is a deprecated alias for `hstack setup-from-source`.) You can choose which HStack build you want:
