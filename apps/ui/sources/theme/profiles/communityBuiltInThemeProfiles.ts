...
export const COMMUNITY_BUILT_IN_THEME_PROFILES: readonly BuiltInThemeProfileDefinition[] = [
    ...
    createDarkProfile('graphiteDark', 'Graphite Dark', {
        ...
        pressedOverlay: 'rgba(234,234,234,0.035)', ripple: 'rgba(234,234,234,0.055)', borderDefault: 'rgba(255,255,255,0.045)', borderSurface: 'rgba(255,255,255,0.055)', borderStrong: 'rgba(255,255,255,0.085)', borderModal: 'rgba(255,255,255,0.060)', highlight: 'transparent',
    ...
    createLightProfile('paperLight', 'Paper Light', {
        ...
        pressedOverlay: 'rgba(28,28,28,0.04)', ripple: 'rgba(28,28,28,0.06)', borderDefault: 'rgba(68,68,68,0.10)', borderSurface: 'rgba(68,68,68,0.12)', borderStrong: 'rgba(68,68,68,0.20)', borderModal: 'rgba(68,68,68,0.14)', highlight: 'transparent',
