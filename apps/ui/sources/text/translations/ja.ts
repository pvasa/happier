...
localTailscale: {
  ...
  connectedServices: {
    ...
    detail: {
      ...
      errors: {
        credentialReferencedByGroup: "このアカウントはまだアカウントグループで使用されています。グループから削除してからもう一度お試しください。",
        credentialNotFound: "この接続済みアカウントはすでに削除されています。",
        credentialRequestFailed: "接続済みアカウントのリクエストに失敗しました。接続済みサービスを更新してもう一度お試しください。",
        groupRequestFailed: "アカウントグループのリクエストに失敗しました。接続済みサービスを更新してもう一度お試しください。",
        generationConflict: "操作の完了前にこのアカウントグループが変更されました。接続済みサービスを更新してもう一度お試しください。",
        groupNotFound: "このアカウントグループはもう存在しません。接続済みサービスを更新してもう一度お試しください。",
        memberNotFound: "このアカウントはもうグループのメンバーではありません。接続済みサービスを更新してもう一度お試しください。",
        profileNotFound: "この接続済みアカウントはもう存在しません。接続済みサービスを更新してもう一度お試しください。",
        fallbackDisabled: "このサーバーでは手動グループ切り替えが無効です。",
        ...
        disconnectGroupCleanupRetryTitle: "グループから削除しますか？",
        disconnectGroupCleanupRetryBody: ({ service, profileId }: { service: string; profileId: string }) =>
          `${service}（${profileId}）はまだアカウントグループで使用されています。グループから削除して切断しますか？`,
    ...
    authModal: {
      ...
      groupSwitchingSubtitle: "グループメンバーを切り替え中",
      groupErrorSubtitle: "このグループには対応が必要です",
      groupUnknownSubtitle: "準備状況をまだ同期中です",
      groupUnsupportedSubtitle: "このランタイムではアカウントグループを切り替えられません",
