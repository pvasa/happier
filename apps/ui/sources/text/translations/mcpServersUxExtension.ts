...
import { DEFAULT_LANGUAGE, SUPPORTED_LANGUAGE_CODES, type SupportedLanguage } from '../_all';
...
type McpServersUxTranslationExtension = typeof englishMcpServersUxTranslationExtension;
...
function resolveActiveMcpServersUxLocale(): McpServersUxLocale {
  const language = resolveActiveLanguage();
  return mcpServersUxLocales.includes(language as McpServersUxLocale) ? (language as McpServersUxLocale) : 'en';
}

function getActiveMcpServersUxTranslationExtension(): McpServersUxTranslationExtension {
  return mcpServersUxTranslationExtensions[resolveActiveMcpServersUxLocale()];
}

// Locale files spread `mcpServersUxTranslationExtension` directly. To avoid leaking English into non-English locales
// without editing locale files, we export a leaf-function tree that resolves the active language at call time.
export const mcpServersUxTranslationExtension = {
  mcpServersConfiguredEmptySubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersConfiguredEmptySubtitle,
  mcpServersHeroSubtitle: ({ configuredCount }: { configuredCount: number }) =>
    getActiveMcpServersUxTranslationExtension().mcpServersHeroSubtitle({ configuredCount }),
  mcpServersHeroSubtitleEmpty: () => getActiveMcpServersUxTranslationExtension().mcpServersHeroSubtitleEmpty,
  mcpServersSegmentConfigured: () => getActiveMcpServersUxTranslationExtension().mcpServersSegmentConfigured,
  mcpServersSegmentConfiguredSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersSegmentConfiguredSubtitle,
  mcpServersSegmentDetected: () => getActiveMcpServersUxTranslationExtension().mcpServersSegmentDetected,
  mcpServersSegmentDetectedSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersSegmentDetectedSubtitle,
  mcpServersSegmentPreview: () => getActiveMcpServersUxTranslationExtension().mcpServersSegmentPreview,
  mcpServersSegmentPreviewSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersSegmentPreviewSubtitle,
  mcpServersAdvancedTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersAdvancedTitle,
  mcpServersAdvancedSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersAdvancedSubtitle,
  mcpServersDetectedDirectoryTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersDetectedDirectoryTitle,
  mcpServersDetectedDirectorySubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersDetectedDirectorySubtitle,
  mcpServersDetectedDirectoryPlaceholder: () => getActiveMcpServersUxTranslationExtension().mcpServersDetectedDirectoryPlaceholder,
  mcpServersPreviewAgentTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersPreviewAgentTitle,
  mcpServersPreviewMachineTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersPreviewMachineTitle,
  mcpServersPreviewDeliveryTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersPreviewDeliveryTitle,
  mcpServersPreviewDirectoryTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersPreviewDirectoryTitle,
  mcpServersPreviewDirectorySubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersPreviewDirectorySubtitle,
  mcpServersPreviewDirectoryPlaceholder: () => getActiveMcpServersUxTranslationExtension().mcpServersPreviewDirectoryPlaceholder,
  mcpServersPreviewRefreshTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersPreviewRefreshTitle,
  mcpServersPreviewRefreshSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersPreviewRefreshSubtitle,
  mcpServersPreviewEmptyTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersPreviewEmptyTitle,
  mcpServersPreviewEmptySubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersPreviewEmptySubtitle,
  mcpServersPreviewDirectoryRequired: () => getActiveMcpServersUxTranslationExtension().mcpServersPreviewDirectoryRequired,
  mcpServersBuiltInDescription: () => getActiveMcpServersUxTranslationExtension().mcpServersBuiltInDescription,
  mcpServersSourceHappier: () => getActiveMcpServersUxTranslationExtension().mcpServersSourceHappier,
  mcpServersSourceBuiltIn: () => getActiveMcpServersUxTranslationExtension().mcpServersSourceBuiltIn,
  mcpServersSourceDetected: () => getActiveMcpServersUxTranslationExtension().mcpServersSourceDetected,
  mcpServersQuickInstallTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersQuickInstallTitle,
  mcpServersQuickInstallSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersQuickInstallSubtitle,
  mcpServersQuickInstallAction: () => getActiveMcpServersUxTranslationExtension().mcpServersQuickInstallAction,
  mcpServersQuickInstallEmptyTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersQuickInstallEmptyTitle,
  mcpServersQuickInstallEmptySubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersQuickInstallEmptySubtitle,
  mcpServersEditAction: () => getActiveMcpServersUxTranslationExtension().mcpServersEditAction,
  mcpServersDeleteAction: () => getActiveMcpServersUxTranslationExtension().mcpServersDeleteAction,
  mcpServersAddServerFlowSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersAddServerFlowSubtitle,
  mcpServersAddFlowConfigureTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersAddFlowConfigureTitle,
  mcpServersAddFlowConfigureSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersAddFlowConfigureSubtitle,
  mcpServersAddFlowImportJsonTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersAddFlowImportJsonTitle,
  mcpServersAddFlowImportJsonSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersAddFlowImportJsonSubtitle,
  mcpServersAddFlowQuickInstallTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersAddFlowQuickInstallTitle,
  mcpServersAddFlowQuickInstallSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersAddFlowQuickInstallSubtitle,
  mcpServersFieldCommandLine: () => getActiveMcpServersUxTranslationExtension().mcpServersFieldCommandLine,
  mcpServersFieldCommandLinePlaceholder: () => getActiveMcpServersUxTranslationExtension().mcpServersFieldCommandLinePlaceholder,
  mcpServersTransportLocalTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersTransportLocalTitle,
  mcpServersTransportLocalSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersTransportLocalSubtitle,
  mcpServersTransportHttpTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersTransportHttpTitle,
  mcpServersTransportHttpSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersTransportHttpSubtitle,
  mcpServersTransportSseTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersTransportSseTitle,
  mcpServersTransportSseSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersTransportSseSubtitle,
  mcpServersAdvancedCommandEditorTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersAdvancedCommandEditorTitle,
  mcpServersAdvancedCommandEditorSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersAdvancedCommandEditorSubtitle,
  mcpServersCancelSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersCancelSubtitle,
  mcpServersImportJsonTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersImportJsonTitle,
  mcpServersImportJsonSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersImportJsonSubtitle,
  mcpServersImportJsonPlaceholder: () => getActiveMcpServersUxTranslationExtension().mcpServersImportJsonPlaceholder,
  mcpServersImportJsonErrorTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersImportJsonErrorTitle,
  mcpServersImportJsonWarningsTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersImportJsonWarningsTitle,
  mcpServersImportJsonEmptyTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersImportJsonEmptyTitle,
  mcpServersImportJsonEmptySubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersImportJsonEmptySubtitle,
  mcpServersImportJsonAction: () => getActiveMcpServersUxTranslationExtension().mcpServersImportJsonAction,
  mcpServersImportMappingSavedSecret: () => getActiveMcpServersUxTranslationExtension().mcpServersImportMappingSavedSecret,
  mcpServersImportMappingMachineEnv: () => getActiveMcpServersUxTranslationExtension().mcpServersImportMappingMachineEnv,
  mcpServersImportSecretNamePlaceholder: () => getActiveMcpServersUxTranslationExtension().mcpServersImportSecretNamePlaceholder,
  mcpServersImportSecretValuePlaceholder: () => getActiveMcpServersUxTranslationExtension().mcpServersImportSecretValuePlaceholder,
  mcpServersImportMachineEnvPlaceholder: () => getActiveMcpServersUxTranslationExtension().mcpServersImportMachineEnvPlaceholder,
  mcpServersImportMappingMissingSecretName: ({ input }: { input: string }) =>
    getActiveMcpServersUxTranslationExtension().mcpServersImportMappingMissingSecretName({ input }),
  mcpServersImportMappingMissingSecretValue: ({ input }: { input: string }) =>
    getActiveMcpServersUxTranslationExtension().mcpServersImportMappingMissingSecretValue({ input }),
  mcpServersImportMappingMissingMachineEnvName: ({ input }: { input: string }) =>
    getActiveMcpServersUxTranslationExtension().mcpServersImportMappingMissingMachineEnvName({ input }),
  mcpServersAuthSavedSecret: () => getActiveMcpServersUxTranslationExtension().mcpServersAuthSavedSecret,
  mcpServersAuthMachineEnv: () => getActiveMcpServersUxTranslationExtension().mcpServersAuthMachineEnv,
  mcpServersAuthPlainText: () => getActiveMcpServersUxTranslationExtension().mcpServersAuthPlainText,
  mcpServersAuthUnknown: () => getActiveMcpServersUxTranslationExtension().mcpServersAuthUnknown,
  mcpServersAuthNone: () => getActiveMcpServersUxTranslationExtension().mcpServersAuthNone,
  mcpServersScopeAllMachines: () => getActiveMcpServersUxTranslationExtension().mcpServersScopeAllMachines,
  mcpServersScopeMachine: () => getActiveMcpServersUxTranslationExtension().mcpServersScopeMachine,
  mcpServersScopeWorkspace: () => getActiveMcpServersUxTranslationExtension().mcpServersScopeWorkspace,
  mcpServersScopeProviderProject: () => getActiveMcpServersUxTranslationExtension().mcpServersScopeProviderProject,
  mcpServersScopeProviderUser: () => getActiveMcpServersUxTranslationExtension().mcpServersScopeProviderUser,
  mcpServersScopeBuiltIn: () => getActiveMcpServersUxTranslationExtension().mcpServersScopeBuiltIn,
  mcpServersStatusActive: () => getActiveMcpServersUxTranslationExtension().mcpServersStatusActive,
  mcpServersStatusAvailable: () => getActiveMcpServersUxTranslationExtension().mcpServersStatusAvailable,
  mcpServersStatusUnavailable: () => getActiveMcpServersUxTranslationExtension().mcpServersStatusUnavailable,
  mcpServersStatusDetected: ({ provider }: { provider: string }) =>
    getActiveMcpServersUxTranslationExtension().mcpServersStatusDetected({ provider }),
  mcpServersStatusDisabledInProvider: ({ provider }: { provider: string }) =>
    getActiveMcpServersUxTranslationExtension().mcpServersStatusDisabledInProvider({ provider }),
  mcpServersEditorAppliesTo: () => getActiveMcpServersUxTranslationExtension().mcpServersEditorAppliesTo,
  mcpServersEditorAppliesToSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersEditorAppliesToSubtitle,
  mcpServersAddApplyRule: () => getActiveMcpServersUxTranslationExtension().mcpServersAddApplyRule,
  mcpServersAddApplyRuleSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersAddApplyRuleSubtitle,
  mcpServersAddApplyRuleHelp: () => getActiveMcpServersUxTranslationExtension().mcpServersAddApplyRuleHelp,
  mcpServersAddApplyRuleSave: () => getActiveMcpServersUxTranslationExtension().mcpServersAddApplyRuleSave,
  mcpServersDeliveryNativeTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersDeliveryNativeTitle,
  mcpServersDeliveryNativeSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersDeliveryNativeSubtitle,
  mcpServersDeliveryShellBridgeTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersDeliveryShellBridgeTitle,
  mcpServersDeliveryShellBridgeSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersDeliveryShellBridgeSubtitle,
  mcpServersDeliveryUnsupportedTitle: () => getActiveMcpServersUxTranslationExtension().mcpServersDeliveryUnsupportedTitle,
  mcpServersDeliveryUnsupportedSubtitle: () => getActiveMcpServersUxTranslationExtension().mcpServersDeliveryUnsupportedSubtitle,
} as const;
