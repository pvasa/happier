...
export const en = {
    ...
    connectedServices: {
        ...
        detail: {
            ...
            errors: {
                credentialReferencedByGroup: 'This account is still used by an account group. Remove it from the group, then try again.',
                ...
                groupRequestFailed: 'The account group request failed. Refresh connected services and try again.',
                generationConflict: 'This account group changed before the action completed. Refresh connected services and try again.',
                groupNotFound: 'This account group no longer exists. Refresh connected services and try again.',
                memberNotFound: 'This account is no longer a member of the group. Refresh connected services and try again.',
                profileNotFound: 'This connected account no longer exists. Refresh connected services and try again.',
                fallbackDisabled: 'Manual group switching is disabled by this server.',
                ...
                disconnectGroupCleanupRetryTitle: 'Remove from groups?',
                disconnectGroupCleanupRetryBody: ({ service, profileId }: { service: string; profileId: string }) =>
                    `${service} (${profileId}) is still used by an account group. Remove it from groups and disconnect it?`,
        ...
        authModal: {
            ...
            groupSwitchingSubtitle: 'Switching group member',
            groupErrorSubtitle: 'This group needs attention',
