...
export const ca: TranslationStructure = {
    ...
    connectedServices: {
        ...
        detail: {
            ...
            errors: {
                credentialReferencedByGroup: 'Aquest compte encara s’utilitza en un grup de comptes. Treu-lo del grup i torna-ho a provar.',
                ...
                groupRequestFailed: 'La sol·licitud del grup de comptes ha fallat. Actualitza els serveis connectats i torna-ho a provar.',
                generationConflict: 'Aquest grup de comptes ha canviat abans que l’acció acabés. Actualitza els serveis connectats i torna-ho a provar.',
                groupNotFound: 'Aquest grup de comptes ja no existeix. Actualitza els serveis connectats i torna-ho a provar.',
                memberNotFound: 'Aquest compte ja no és membre del grup. Actualitza els serveis connectats i torna-ho a provar.',
                profileNotFound: 'Aquest compte connectat ja no existeix. Actualitza els serveis connectats i torna-ho a provar.',
                fallbackDisabled: 'Aquest servidor ha desactivat el canvi manual de grup.',
                ...
                disconnectGroupCleanupRetryTitle: 'Treure dels grups?',
                disconnectGroupCleanupRetryBody: ({ service, profileId }: { service: string; profileId: string }) =>
                    `${service} (${profileId}) encara s’utilitza en un grup de comptes. Treure'l dels grups i desconnectar-lo?`,
        ...
        authModal: {
            ...
            groupSwitchingSubtitle: 'Canviant membre del grup',
            groupErrorSubtitle: 'Aquest grup necessita atenció',
            groupUnknownSubtitle: 'La disponibilitat encara se sincronitza',
            groupUnsupportedSubtitle: 'Aquest runtime no pot canviar grups de comptes',
    ...
    settingsAppearance: {
      tabBarAppearance: {
        ...
        sizeRegular: 'Normal',
        sizeLarge: 'Gran',
        blur: 'Difuminat de la barra de pestanyes',
...
deps: {
  ...
  newSession: {
    ...
    sourceControlWorkspace: {
        ...
        hermesSessionId: 'ID de la sessió de Hermes',
        cursorSessionIdCopied: 'ID de sessió de Cursor copiat al porta-retalls',
        hermesSessionIdCopied: 'ID de la sessió de Hermes copiat al porta-retalls',
    ...
    defaultStorage: {
      ...
      currently: ({ label }: { label: string }) => `Actualment: ${label}`,
        ...
        aiBackend: {
            ...
            hermesSubtitleExperimental: 'CLI de Hermes (en proves)',
        },
        tmux: {
            title: 'Tmux',
