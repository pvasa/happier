...
export const ca: TranslationStructure = {
    ...
    connectedServices: {
        ...
        detail: {
            ...
            connectSetupTokenSubtitle: 'Enganxa un setup-token de Claude',
            ...
            prompts: {
                ...
                setupTokenBody: 'Enganxa el teu setup-token de Claude.',
    ...
    executionRuns: {
        ...
        details: {
	        ...
	        thinking: {
	            ...
	            displayMode: {
	                inlineTitle: 'En línia (per defecte)',
	                inlineSubtitle: 'Mostra els missatges de pensament directament a la transcripció.',
