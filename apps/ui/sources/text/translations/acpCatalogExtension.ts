...
export const acpCatalogTranslationExtensions = {
    en: { settings: settingsAcpCatalogExtension },
    ru: { settings: settingsAcpCatalogExtension },
    pl: { settings: settingsAcpCatalogExtension },
    es: { settings: settingsAcpCatalogExtension },
    it: { settings: settingsAcpCatalogExtension },
    pt: { settings: settingsAcpCatalogExtension },
    ca: { settings: settingsAcpCatalogExtension },
    'zh-Hans': { settings: settingsAcpCatalogExtension },
    'zh-Hant': { settings: settingsAcpCatalogExtension },
    ja: { settings: settingsAcpCatalogExtension },
} as const;
