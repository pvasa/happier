...
export const it: TranslationStructure = {
  ...
  profiles: {
    ...
    aiBackend: {
      ...
      hermesSubtitleExperimental: "Hermes CLI (sperimentale)",
    },
    tmux: {
      title: "Tmux",
  ...
  connectedServices: {
    ...
    detail: {
      ...
      errors: {
        credentialReferencedByGroup: "Questo account è ancora usato da un gruppo di account. Rimuovilo dal gruppo e riprova.",
        ...
        groupRequestFailed: "La richiesta del gruppo di account non è riuscita. Aggiorna i servizi connessi e riprova.",
        generationConflict: "Questo gruppo di account è cambiato prima del completamento dell'azione. Aggiorna i servizi connessi e riprova.",
        groupNotFound: "Questo gruppo di account non esiste più. Aggiorna i servizi connessi e riprova.",
        memberNotFound: "Questo account non fa più parte del gruppo. Aggiorna i servizi connessi e riprova.",
        profileNotFound: "Questo account connesso non esiste più. Aggiorna i servizi connessi e riprova.",
        fallbackDisabled: "Il cambio manuale di gruppo è disattivato da questo server.",
        ...
        disconnectGroupCleanupRetryTitle: "Rimuovere dai gruppi?",
        disconnectGroupCleanupRetryBody: ({ service, profileId }: { service: string; profileId: string }) =>
          `${service} (${profileId}) è ancora usato da un gruppo di account. Rimuoverlo dai gruppi e disconnetterlo?`,
    ...
    authModal: {
      ...
      groupSwitchingSubtitle: "Cambio membro del gruppo",
      groupErrorSubtitle: "Questo gruppo richiede attenzione",
      groupUnknownSubtitle: "La disponibilità è ancora in sincronizzazione",
      groupUnsupportedSubtitle: "Questo runtime non può cambiare gruppi di account",
  ...
  directSessions: {
    ...
    hermesSessionId: "ID sessione Hermes",
    cursorSessionIdCopied: "ID sessione Cursor copiato negli appunti",
    hermesSessionIdCopied: "ID sessione Hermes copiato negli appunti",
