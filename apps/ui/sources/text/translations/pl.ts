...
export const pl: TranslationStructure = {
  ...
  connectedServices: {
    ...
    detail: {
      ...
      errors: {
        credentialReferencedByGroup: "To konto jest nadal używane przez grupę kont. Usuń je z grupy i spróbuj ponownie.",
        ...
        groupRequestFailed: "Żądanie grupy kont nie powiodło się. Odśwież połączone usługi i spróbuj ponownie.",
        generationConflict: "Ta grupa kont zmieniła się przed zakończeniem akcji. Odśwież połączone usługi i spróbuj ponownie.",
        groupNotFound: "Ta grupa kont już nie istnieje. Odśwież połączone usługi i spróbuj ponownie.",
        memberNotFound: "To konto nie jest już członkiem grupy. Odśwież połączone usługi i spróbuj ponownie.",
        profileNotFound: "To połączone konto już nie istnieje. Odśwież połączone usługi i spróbuj ponownie.",
        fallbackDisabled: "Ręczne przełączanie grup jest wyłączone przez ten serwer.",
        ...
        disconnectGroupCleanupRetryTitle: "Usunąć z grup?",
        disconnectGroupCleanupRetryBody: ({ service, profileId }: { service: string; profileId: string }) =>
          `${service} (${profileId}) jest nadal używane przez grupę kont. Usunąć je z grup i odłączyć?`,
    ...
    authModal: {
      ...
      groupSwitchingSubtitle: "Przełączanie członka grupy",
      groupErrorSubtitle: "Ta grupa wymaga uwagi",
      groupUnknownSubtitle: "Gotowość nadal się synchronizuje",
      groupUnsupportedSubtitle: "Ten runtime nie może przełączać grup kont",
  ...
  directSessions: {
    ...
    hermesSessionId: "ID sesji Hermes",
    cursorSessionIdCopied: "ID sesji Cursor skopiowano do schowka",
    hermesSessionIdCopied: "ID sesji Hermes skopiowane do schowka",
...
settingsSession: {
  ...
  profiles: {
    ...
    aiBackend: {
      ...
      hermesSubtitleExperimental: "Hermes CLI (eksperymentalne)",
    },
    tmux: {
      title: "Tmux",
