...
export const pt: TranslationStructure = {
  ...
  connectedServices: {
    ...
    detail: {
      ...
      errors: {
        credentialReferencedByGroup: "Esta conta ainda é usada por um grupo de contas. Remova-a do grupo e tente novamente.",
        ...
        groupRequestFailed: "A solicitação do grupo de contas falhou. Atualize os serviços conectados e tente novamente.",
        generationConflict: "Este grupo de contas mudou antes da ação terminar. Atualize os serviços conectados e tente novamente.",
        groupNotFound: "Este grupo de contas não existe mais. Atualize os serviços conectados e tente novamente.",
        memberNotFound: "Esta conta não é mais membro do grupo. Atualize os serviços conectados e tente novamente.",
        profileNotFound: "Esta conta conectada não existe mais. Atualize os serviços conectados e tente novamente.",
        fallbackDisabled: "A troca manual de grupo está desativada por este servidor.",
        ...
        disconnectGroupCleanupRetryTitle: "Remover dos grupos?",
        disconnectGroupCleanupRetryBody: ({ service, profileId }: { service: string; profileId: string }) =>
          `${service} (${profileId}) ainda é usada por um grupo de contas. Removê-la dos grupos e desconectá-la?`,
    ...
    authModal: {
      ...
      groupSwitchingSubtitle: "Trocando membro do grupo",
      groupErrorSubtitle: "Este grupo precisa de atenção",
      groupUnknownSubtitle: "A prontidão ainda está sincronizando",
      groupUnsupportedSubtitle: "Este runtime não pode trocar grupos de contas",
  ...
  settingsAppearance: {
    tabBarAppearance: {
      ...
      sizeRegular: 'Normal',
      sizeLarge: 'Grande',
      blur: 'Desfoque da barra de abas',
