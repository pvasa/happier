...
const zhHantOverrides: DeepPartial<TranslationStructure> = {
    ...
    connectedServices: {
        ...
        detail: {
            ...
            connectSetupTokenSubtitle: '貼上 Claude 的 setup-token',
        },
        authModal: {
    ...
    toolView: {
        ...
        workspaceIndexingPermission: {
            defaultTitle: '工作區索引',
            description: '索引可協助代理更快搜尋你的程式碼庫並提供更精準的答案。這可能會掃描工作區中的檔案。',
            optionFallback: '選項',
            chooseOptionHint: '請選擇下方的選項以繼續。',
        },
        acpHistoryImport: {
            title: '匯入工作階段歷史記錄？',
            defaultNote: '此工作階段歷史記錄與 Happier 中既有內容不同。匯入可能會產生重複項目。',
            counts: {
    ...
    executionRuns: {
	    ...
	    settingsSession: {
	        ...
	        toolRendering: {
	            ...
	            activityFeed: {
	                defaultDetailTitle: '活動動態預設細節',
	                expandedDetailTitle: '活動動態展開細節',
	                tapActionTitle: '點擊動作（活動動態）',
	                tapAction: {
	                    expandTitle: '展開',
	                ...
	                defaultExpandedSubtitle: '在活動動態中預設展開工具列。',
	            },
	        ...
	        transcript: {
	            ...
	            activityGroupTitle: '將工具分組到活動',
	            activityGroupSubtitle: '在每個回合中將工具呼叫壓縮成活動區段。',
	            ...
	            jumpToBottomTitle: '跳至底部按鈕',
	            jumpToBottomSubtitle: '當你往上捲動且有新活動到達時顯示按鈕。',
	            advancedScrollTitle: '進階捲動…',
	            advancedScrollSubtitle: '微調固定門檻與計數。',
	            advanced: {
	                turnGroupingTitle: '回合分組',
	                turnGroupingFooter: '控制每個回合中活動如何形成。',
	                activityStrategyTitle: '活動分組策略',
	                activityStrategy: {
	                    consecutiveTitle: '連續工具（預設）',
	                    consecutiveSubtitle: '只將連續的工具呼叫分組到活動中。',
	                    allToolsTitle: '回合內所有工具',
	                    allToolsSubtitle: '將回合內所有工具呼叫分組為單一活動區段。',
	                },
                    activityCollapsedPreviewCountTitle: '摺疊預覽',
                    activityCollapsedPreviewCountSubtitle: ({ value }: { value: string }) => `當活動摺疊時顯示最近 ${value} 個工具。`,
	        ...
	        toolDetailLevel: {
                ...
                styleDefaultSubtitle: '卡片：摘要。活動動態：精簡。',
                expandedStyleDefaultTitle: '預設（建議）',
                expandedStyleDefaultSubtitle: '卡片：完整。活動動態：摘要。',
	        },
	        terminalConnect: {
	            title: '終端連線',
