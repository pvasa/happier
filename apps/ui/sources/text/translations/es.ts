...
export const es: TranslationStructure = {
  ...
  connectedServices: {
    ...
    detail: {
      ...
      errors: {
        credentialReferencedByGroup: "Esta cuenta todavía se usa en un grupo de cuentas. Quítala del grupo y vuelve a intentarlo.",
        ...
        groupRequestFailed: "La solicitud del grupo de cuentas falló. Actualiza los servicios conectados y vuelve a intentarlo.",
        generationConflict: "Este grupo de cuentas cambió antes de que terminara la acción. Actualiza los servicios conectados y vuelve a intentarlo.",
        groupNotFound: "Este grupo de cuentas ya no existe. Actualiza los servicios conectados y vuelve a intentarlo.",
        memberNotFound: "Esta cuenta ya no es miembro del grupo. Actualiza los servicios conectados y vuelve a intentarlo.",
        profileNotFound: "Esta cuenta conectada ya no existe. Actualiza los servicios conectados y vuelve a intentarlo.",
        fallbackDisabled: "Este servidor desactivó el cambio manual de grupo.",
        ...
        disconnectGroupCleanupRetryTitle: "¿Quitar de los grupos?",
        disconnectGroupCleanupRetryBody: ({ service, profileId }: { service: string; profileId: string }) =>
          `${service} (${profileId}) todavía se usa en un grupo de cuentas. ¿Quitarla de los grupos y desconectarla?`,
    ...
    authModal: {
      ...
      groupSwitchingSubtitle: "Cambiando miembro del grupo",
      groupErrorSubtitle: "Este grupo necesita atención",
      groupUnknownSubtitle: "La disponibilidad aún se está sincronizando",
      groupUnsupportedSubtitle: "Este runtime no puede cambiar grupos de cuentas",
  ...
  settingsAppearance: {
    tabBarAppearance: {
      ...
      sizeRegular: 'Normal',
      sizeLarge: 'Grande',
      blur: 'Desenfoque de la barra de pestañas',
  ...
  directSessions: {
    ...
    hermesSessionId: "ID de sesión de Hermes",
    cursorSessionIdCopied: "ID de sesión de Cursor copiado al portapapeles",
    hermesSessionIdCopied: "ID de sesión de Hermes copiado al portapapeles",
...
settingsSession: {
  ...
  profiles: {
    ...
    aiBackend: {
      ...
      hermesSubtitleExperimental: "CLI de Hermes (en pruebas)",
    },
    tmux: {
      title: "Tmux",
